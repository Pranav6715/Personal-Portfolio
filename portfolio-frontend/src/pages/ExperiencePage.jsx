                ...
                <div className="relative border-l-4 border-[#ff7b00] ml-2 sm:ml-4 md:ml-12 space-y-8 md:space-y-12">
                    {experiences.map((exp, index) => (
                        <div key={index} className="relative pl-8 sm:pl-10 group">
                            ...
                            <div className="bg-white dark:bg-white/5 p-6 sm:p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-white/10 hover:shadow-2xl hover:border-[#ff7b00] dark:hover:border-[#ff7b00] transition-all duration-300 transform hover:-translate-y-1">
