                            ...
                            <div className="relative h-48 sm:h-56 overflow-hidden">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-gray-900/80 dark:from-[#0a192f]/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                                    <div className="text-white">
                                        ...
                                        <p className="text-xs md:text-sm text-gray-200 dark:text-gray-300 capitalize">{project.category} Project</p>
                                    </div>
                                </div>
                            </div>

                            <div className="p-6">
                                <h3 className="text-lg md:text-xl font-bold text-gray-900 dark:text-white mb-3 group-hover:text-[#ff7b00] dark:group-hover:text-[#ff7b00] transition-colors duration-300">
                                    {project.name}
                                </h3>
                                <p className="text-sm md:text-base text-gray-700 dark:text-gray-400 mb-6 flex-grow transition-colors duration-300">
                                    {project.desc}
                                </p>
                                <div className="flex justify-between items-center mt-auto gap-4">
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        className="flex-1 inline-flex items-center justify-center gap-2 bg-gray-200 dark:bg-white/10 hover:bg-[#ff7b00] dark:hover:bg-[#ff7b00] text-gray-900 dark:text-white hover:text-white px-4 py-2 rounded-lg font-semibold transition-all duration-300 border border-gray-300 dark:border-white/10 shadow-md transform hover:scale-105"
                                    >
                                        Code <FaCode />
                                    </a>
                                    {project.links.view && (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noreferrer"
                                            className="inline-flex items-center gap-2 text-[#ff7b00] font-bold hover:underline text-sm md:text-base whitespace-nowrap"
                                        >
