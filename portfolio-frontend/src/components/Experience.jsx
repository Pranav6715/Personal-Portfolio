    ...
    return (
        <section id="experience" className="py-20 bg-slate-50 dark:bg-[#0a192f] transition-colors duration-300">
            <div className="container mx-auto px-6 md:px-12">
                ...
                <div className="relative border-l-4 border-[#ff7b00] ml-2 sm:ml-4 md:ml-12 space-y-8 md:space-y-12">
                    {experiences.map((exp, index) => (
                        <div key={index} className="relative pl-8 sm:pl-10 group">
                            ...
                            <div className="bg-white dark:bg-white/5 backdrop-blur-sm p-6 md:p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-white/10 hover:shadow-2xl hover:border-[#ff7b00] dark:hover:border-[#ff7b00] transition-all duration-300 transform hover:-translate-y-1">
                                ...
                                <h4 className="text-lg md:text-xl font-semibold text-[#ff7b00] mb-2">{exp.role}</h4>
                                <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 font-medium transition-colors duration-300">{exp.duration}</p>
                            </div>
                        </div>
                    ))}
                </div>
