$(document).ready(function () {
    ...
    .then(response => {
        const msgSpan = document.getElementById("form-message");
        if (response.ok) {
            ...
            msgSpan.textContent = "Failed to submit the form.";
    ...
    .catch(error => {
        const msgSpan = document.getElementById("form-message");
        msgSpan.textContent = "Error occurred: " + error.message;
        msgSpan.style.color = "red";
        msgSpan.style.display = "inline-block";
    });
});
...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Pranav Ghaytadkar";
